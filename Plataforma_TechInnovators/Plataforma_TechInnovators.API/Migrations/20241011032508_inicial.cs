    ...
    public partial class inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hackatones", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdHackaton = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mentores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Mentores_Hackatones_HackatonId",
                        column: x => x.HackatonId,
                        principalTable: "Hackatones",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipos_Hackatones_HackatonId",
                        column: x => x.HackatonId,
                        principalTable: "Hackatones",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Equipos_Mentores_MentorId",
                        column: x => x.MentorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Puntaje = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
